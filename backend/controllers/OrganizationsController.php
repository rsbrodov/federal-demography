...
use common\models\BasicInformationRazdelOrganization;
...
class OrganizationsController extends Controller
{
    ...
    {
        if(Yii::$app->user->can('admin')){
            $users = User::deleteAll('organization_id =:organization_id', [':organization_id' => $id]);
            $AmbulatoryCartCamp = AmbulatoryCartCamp::deleteAll('organization_id =:organization_id', [':organization_id' => $id]);
            $BasicInformation = BasicInformation::deleteAll('organization_id =:organization_id', [':organization_id' => $id]);
            $BasicInformationRazdelOrganization = BasicInformationRazdelOrganization::deleteAll('organization_id =:organization_id', [':organization_id' => $id]);
            $CharactersStolovaya = CharactersStolovaya::deleteAll('organization_id =:organization_id', [':organization_id' => $id]);
            $FactInfCamp = FactInfCamp::deleteAll('organization_id =:organization_id', [':organization_id' => $id]);
            $Kids = Kids::deleteAll('organization_id =:organization_id', [':organization_id' => $id]);
            $menus = Menus::deleteAll('organization_id =:organization_id', [':organization_id' => $id]);
            $SchoolBreak = SchoolBreak::deleteAll('organization_id =:organization_id', [':organization_id' => $id]);
            $Students = Students::deleteAll('organization_id =:organization_id', [':organization_id' => $id]);
            $StudentsNutrition = StudentsNutrition::deleteAll('organization_id =:organization_id', [':organization_id' => $id]);
            $this->findModel($id)->delete();
            Yii::$app->session->setFlash('success', "ДАННЫЕ ПО ОРГАНИЗАЦИИ(если они были) И САМА ОРГАНИЗАЦИЯ БЫЛИ УДАЛЕНЫ НАВСЕГДА!!!!!!!");
