...
<div class="users-nutrition-report-form container"><h2 align="center">Отчет по регистрациям (ПС "Питание") -
        организации</h2>
    <?php
...
<? if (!empty($districts)) //нажали кнопку показать
{
    ...
    <table class="table table-bordered table-sm table-responsive">
        ...
        <tr class="main-color-7">
            ...
            <th class="text-center" rowspan="2" colspan="1">Внесено детей</th>
            <th class="text-center" rowspan="2" colspan="1">Заполнена общая информация</th>
        </tr>
        <tr class="main-color-7">
            ...
            if ($regions) {
                ...
                foreach ($regions as $region)//цикл по регионам
                {
                    ...
                    foreach ($organizations as $organization) {
                        ...
                        $table .= '<td colspan="2">' . $model->get_region($array_org[$i][1]) . '</td>';
                        ...
                        $kid_region_count += Kids::find()
                            ...
                            ->groupBy('organization_id')
                            ->count();
                        $table .= '<td colspan="1" class="text-center">' . $kids_organization_count . '</td>';
                        $basic_information = 0;
                        ...
                        $table .= '<td colspan="1" class="text-center">' . number_format((100 / 7 * $basic_inc_organization), 0) . '%</td>';
                        $table .= '</tr>';
                        echo $table;
                        $i++;
                    }
                    ...
                    if ($count_organizations) {
                        ...
                        $table .= '<td colspan="2">' . $model->get_region($region) . '</td>';
                        ...
                        $table .= '<td colspan="3" class="text-center align-middle"></td>';
                        ...
                        $table .= '<td colspan="9" class="text-center align-middle">Не найдено организаций в регионе</td>';
                        $table .= '</tr>';
                        $table = '';
                    }
                    echo $table;
        ...
        $table .= '<td colspan="4">Итого организаций: </td>';
