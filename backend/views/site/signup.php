...
$type_orgs = TypeOrganization::find()->where(['id' => [1, 7]])->orderby(['name' => SORT_ASC])->all();
...
?>
    ...
    <div class="site-signup m-4">
		...
		<p><strong><b style="color: red">В данном программном средстве зарегистрироваться могут только представители детских оздоровительных организаций отдыха и оздоровления.</strong></b></p>
		<strong><b style="color: red">Если Вам необходимо пройти обучение по санитарно-просветительским программам "Основы здорового питания", 
