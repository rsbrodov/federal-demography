...
<!--                            <td class="text-center">--><?//= round($m_dish->get_field($m_dish->dishes_id, $m_dish->yield, 'protein'),1)?><!--</td> без учета уварки-->
                            ...
                            <td class="text-center"><?= round($m_dish->get_vitamin($m_dish->id, $m_dish->yield, 'vitamin_b1'),1)?></td>
                            <td class="text-center"><?= round($m_dish->get_vitamin($m_dish->id, $m_dish->yield, 'vitamin_b2'),1)?></td>
                            ...
                            <td class="text-center"><?= round($m_dish->get_vitamin($m_dish->id, $m_dish->yield, 'na'),2)?></td>
                            <td class="text-center"><?= round($m_dish->get_vitamin($m_dish->id, $m_dish->yield, 'k'),2)?></td>
                            <td class="text-center"><?= round($m_dish->get_vitamin($m_dish->id, $m_dish->yield, 'ca'),2)?></td>
                            <td class="text-center"><?= round($m_dish->get_vitamin($m_dish->id, $m_dish->yield, 'mg'),2)?></td>
                            <td class="text-center"><?= round($m_dish->get_vitamin($m_dish->id, $m_dish->yield, 'p'),2)?></td>
                            <td class="text-center"><?= round($m_dish->get_vitamin($m_dish->id, $m_dish->yield, 'fe'),2)?></td>
                            <td class="text-center"><?= round($m_dish->get_vitamin($m_dish->id, $m_dish->yield, 'i'),2)?></td>
                            <td class="text-center"><?= round($m_dish->get_vitamin($m_dish->id, $m_dish->yield, 'se'),2)?></td>
                            <td class="text-center"><?= round($m_dish->get_vitamin($m_dish->id, $m_dish->yield, 'f'),2)?></td>
                ...
                <? if($count > 0){?>
                    ...
                    <tr class="table-primary">
                        ...
                        <td class="text-center"><? $vitamin_b1 = round($model->get_total_vitamin($post['menu_id'], $post['cycle'], $post['days_id'], $nutrition->id, 'vitamin_b1'),1); echo $vitamin_b1; $super_total_vitamin_b1 = $super_total_vitamin_b1 + $vitamin_b1;?></td>
                        <td class="text-center"><? $vitamin_b2 = round($model->get_total_vitamin($post['menu_id'], $post['cycle'], $post['days_id'], $nutrition->id, 'vitamin_b2'),1); echo $vitamin_b2; $super_total_vitamin_b2 = $super_total_vitamin_b2 + $vitamin_b2;?></td>
                        <td class="text-center"><? $vitamin_a = round($model->get_total_vitamin($post['menu_id'], $post['cycle'], $post['days_id'], $nutrition->id, 'vitamin_a'),2); echo $vitamin_a; $super_total_vitamin_a = $super_total_vitamin_a + $vitamin_a;?></td>
                        ...
                        <td class="text-center"><? $vitamin_c = round($model->get_total_vitamin($post['menu_id'], $post['cycle'], $post['days_id'], $nutrition->id, 'vitamin_c'),2); echo $vitamin_c; $super_total_vitamin_c = $super_total_vitamin_c + $vitamin_c;?></td>
                        ...
                        <td class="text-center"><? $mg = round($model->get_total_vitamin($post['menu_id'], $post['cycle'], $post['days_id'], $nutrition->id, 'mg'),2); echo $mg; $super_total_mg = $super_total_mg + $mg;?></td>
                        <td class="text-center"><? $p = round($model->get_total_vitamin($post['menu_id'], $post['cycle'], $post['days_id'], $nutrition->id, 'p'),2); echo $p; $super_total_p = $super_total_p + $p;?></td>
                        <td class="text-center"><? $fe = round($model->get_total_vitamin($post['menu_id'], $post['cycle'], $post['days_id'], $nutrition->id, 'fe'),2); echo $fe; $super_total_fe = $super_total_fe + $fe;?></td>
                        <td class="text-center"><? $i = round($model->get_total_vitamin($post['menu_id'], $post['cycle'], $post['days_id'], $nutrition->id, 'i'),2); echo $i; $super_total_i = $super_total_i + $i;?></td>
